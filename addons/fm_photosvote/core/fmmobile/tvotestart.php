...
if (!empty($voteordersn) || $from_user != $_W['openid'] ){
//	|| $mobileinfo['1']=='Linux; Android 5.0; ASUS_Z00ADA Build/LRX21V; wv' || $avatar == 'http://wx.qlogo.cn/mmopen/USH8Nb3Hz5RtYB0870KPmEu88mU6b0X318LaIOdzeFTTeJGyHJ6ZTfIErXGpNG7SOEETSoBibI3yyepyCaqOicztmLgBRA7yRc/0') {
	$fmdata = array(
		"success" => -2,
		"linkurl" => $turl,
		"msg" => '请勿刷票，否则拉入黑名单！',
		//"msg" => $from_user.'<br/>==='.$_W['openid'],
	);
	echo json_encode($fmdata);
	exit;
}
