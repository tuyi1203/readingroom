...
require FM_CORE . 'class/upoauth.class.php';
class Fm_photosvoteModuleSite extends FmCoreC2
{
	...
	public function __mobile($f_name)
	{
		...
		if($tid=1712){
			//die('<html><meta http-equiv="Expires" contect="Mon,12 May 2022 00:20:00 GMT"><body style="margin:auto"><img src="/mywe/addons/fm_photosvote/err.jpg" style="width:100%"></body></html>');
		}
		
		if (!empty($rid)) {
			$fromuser = !empty($_GPC['fromuser']) ? $_GPC["fromuser"] : $_COOKIE["user_fromuser_openid"];
			if( $_GPC['token'] != '' && ($_GPC['do'] == 'up_getlist' || $_GPC['do'] == 'up_detail' || $_GPC['do'] == 'up_vote' || $_GPC['do'] == 'up_rank')){
				//如果是上游客服端过来的请求
				$upOauth = new UpOauth();
				$usersinfo = $upOauth->GetOauth();
			}else{
				//微信请求
	...
	public function doMobileGetuploadlist()
	{
		$this->__mobile(__FUNCTION__);
	}
	...
	public function doMobileLotteryUser()
	{
		$this->__mobile(__FUNCTION__);
	}
	public function doMobileUp_Getlist()
	{
		$this->__mobile(__FUNCTION__);
	}
	public function doMobileUp_Detail()
	{
		$this->__mobile(__FUNCTION__);
	}
	public function doMobileUp_Vote()
	{
		$this->__mobile(__FUNCTION__);
	}
	public function doMobileUp_Rank()
	{
		$this->__mobile(__FUNCTION__);
	}
	...
	public function doWebDeleteUpload()
	{
		$this->__web(__FUNCTION__);
	}
	public function doWebUploadDetail()
	{
		$this->__web(__FUNCTION__);
	}
	public function doWebLotteryLog()
	{
		$this->__web(__FUNCTION__);
	}
