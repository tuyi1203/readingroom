...
class Wxz_wzbModuleSite extends WeModuleSite {
	...
	public function doWebUsers(){
		...
		$sql='SELECT b.id as id,b.nickname as nickname,b.headimgurl as headimgurl,a.amount as amount,a.deposit as deposit,a.dateline as dateline FROM ' . tablename('wxz_wzb_viewer').' as a inner JOIN ' . tablename('wxz_wzb_user') . ' AS b ON a.uid=b.id '.$condition.' and b.`uniacid`='.$_W['uniacid'].' and a.rid='.$rid.' order by b.id desc limit '.$start.','.$psize;
